  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <select
        ...
        className="rounded-md border border-border bg-surface px-3 py-1.5 text-sm text-fg focus:border-zinc-500 focus:outline-none"
      >
        ...
        {STATUS_TABS.map(({ key, label, dot }) => {
          ...
          return (
            ...
            >
              ...
              {label}
              <span className="tabular-nums text-fg-muted">{statusCounts[key]}</span>
            </button>
          )
        })}
      </div>
